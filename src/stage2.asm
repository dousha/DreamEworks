...
global SELECTOR_USER_TSS, SELECTOR_SYSTEM_STACK
extern c_kern
...
DESCRIPTOR_USER_TSS: ; need to be inited after kernel loaded
dw 0
dw 0
db 0
db 0
...
SELECTOR_USER_TSS equ DESCRIPTOR_USER_TSS - GDT0
SELECTOR_USER_CODE equ DESCRIPTOR_USER_CODE - GDT0
SELECTOR_USER_DATA equ DESCRIPTOR_USER_DATA - GDT0
SELECTOR_USER_STACK equ DESCRIPTOR_USER_STACK - GDT0
